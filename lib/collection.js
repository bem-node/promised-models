...
Collection = Events.inherit(/** @lends Collection.prototype*/{
    ...
    destruct: function () {
        (this._models || []).forEach(function (model) {
            model.un('any', this._onModelEvent, this);
    ...
    /**
     * Checks if collection is owned by passed instance
     * @param {Model} model
     * @returns {Boolean}
     */
    isOwnedBy: function (model) {
        return Boolean(this._owner) && this._owner === model;
    },
    ...
    _addModelReference: function (model) {
        ...
        model.on('any', this._onModelEvent, this);
    },
